...
Run Claude Code in the root of this repository, then prompt it to set up the development environment using the skills provided below.

## Instructions for Claude Code

Set up the following development environment by using the skills in this repository.
